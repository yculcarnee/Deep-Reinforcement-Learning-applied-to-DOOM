...
def parse_arguments():
    ...
    parser.add_argument("--model_path", type=str, default="drive/saves/model", help="Path to save models")
    parser.add_argument("--frames_path", type=str, default="drive/saves/frames", help="Path to save gifs")
    parser.add_argument("--summary_path", type=str, default="drive/saves/summary", help="Path to save training summary")
    parser.add_argument("--gif_path", type=str, default="drive/saves/player_gifs", help="Path to save playing agent gifs")
